...
- [Starting with Docker containers (Primeros pasos con contenedores en Docker)](#starting-with-docker-containers--primeros-pasos-con-contenedores-en-docker-)
...
- [Starting in a real environment](#starting-in-a-real-environment)
...
- [Basic exercise with containers (homework)](#basic-exercise-with-containers--homework-)
...
* Use your assigned external and internal port.
